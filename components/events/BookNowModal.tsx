        ...
        {isSubmitted ? (
          <div className="py-6">
            ...
            <p className="text-white/70 text-sm leading-relaxed">
              Thanks for registering for <strong>{eventName}</strong>. We&apos;ll
              send confirmation details to your inbox shortly.
            </p>
            <button
              type="button"
              onClick={onClose}
          ...
          <>
            <p className="eyebrow mb-2">Reserve your seat</p>
            <h3
              id="booknow-title"
            ...
            <form ref={formRef} onSubmit={handleSubmit} className="space-y-5">
              ...
              <input
                type="hidden"
                name="other info"
                value={`Event registration: ${eventName} | ${eventDate} | ${eventLocation}`}
              />
